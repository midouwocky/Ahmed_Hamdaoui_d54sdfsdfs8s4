...
public class StudentResource {
    ...
    public ResponseEntity<Student> createStudent(@RequestBody @jakarta.validation.Valid Student student) throws URISyntaxException {
    ...
    public ResponseEntity<Student> partialUpdateStudent(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Student studentDTO
    ) throws URISyntaxException {
